...
- The [Sprint 16 governance package](./PRODUCTION_READINESS_GOVERNANCE.md) is `PROPOSED FOR REVIEW`. It offers independent choices for `OPEN-02`, `OPEN-06`, `OPEN-07`, `OPEN-08`, `OPEN-10`, and `OPEN-12`; `OPEN-10` and `OPEN-12` have product-owner review outcomes of `REVISE`, while every implementation/governance selection remains `PENDING`.
...
| ---------------------------- | --------------------------------------------------------------------------------------- | ------------------------------------ | ------------------------------ | ------------------------------------------------------------------ |
| [OPEN-02](./REQUIREMENTS.md) | Purpose limitation, consent cases, notice, patient rights, and minimum necessary access | `OPEN DECISION`; selection `PENDING` | `NOT RECORDED`                 | Privacy controls only after approval and `OPEN-10` review          |
